...
const Help = () => {
  return (
    <div className="bg-gradient-to-b from-[#C2B0A1] to-[#897765] px-4 py-4 flex flex-col">
      ...
      <div className="flex flex-col  justify-center space-y-2">
        <div className="flex flex-row justify-between bg-white rounded-sm px-2 py-4">
        ...
        <div className="flex flex-col justify-between bg-white rounded-sm px-2 py-4 space-y-2 ">
          <h3>Have Some Suggestions?</h3>
          <textarea
            className="bg-[#f0e0d1] h-32 px-2 py-2 rounded-sm"
            placeholder="type your suggestion here........"
          ></textarea>
          <button className="bg-[#897765] rounded-md px-2 py-2 w-24 h-10 ml-auto">
            Send
          </button>
        </div>
